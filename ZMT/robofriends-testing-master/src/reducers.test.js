...
// The * allows us to access all exports.
// In this case we can reach out to a specific import by
// using the alias and the . syntax followed by the name of the export.

// Example: reducers.searchRobots to get the searchRobots export.
